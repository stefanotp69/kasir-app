    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="/admin/transaksi/detail/selesai/{{ Request::segment(3) }}" class="btn btn-success btn-block"><i class="fas fa-check"></i> Selesai</a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="" method="GET">
                    ...
                    <button type="submit" class="btn btn-primary btn-block mt-2"> Hitung</button>
                </form>
